...
typedef enum
{
	...
	HWE_UART1_RX_EVENT		= 0b0000000000000000000001,					//a new character was received by UART1 (user input)
	HWE_UART2_RX_EVENT		= 0b0000000000000000000010,					//a new character was received by UART2 (camera)
	HWE_LPUART_RX_EVENT		= 0b0000000000000000000100,					//a new character was received by LPUART (GPS)
	HWE_UART1_COMMAND		= 0b0000000000000000001000,					//characters received by UART1 made up a full command
	HWE_LPUART_COMMAND		= 0b0000000000000000010000,					//characters received by LPUART made up a full command
...
//artificial events indicating activities in progress, meant to prevent MCU going to low-power mode to allow the activities to finish
	HWE_UART1_TRANSMITTING	= 0b0000010000000000000000,					//user message transmission is in progress, reset by ISR
	HWE_UART2_TRANSMITTING	= 0b0000100000000000000000,					//transmission to camera is in progress, reset by ISR
	HWE_LPUART_TRANSMITTING	= 0b0001000000000000000000,					//transmission to GPS is in progress, reset by ISR
